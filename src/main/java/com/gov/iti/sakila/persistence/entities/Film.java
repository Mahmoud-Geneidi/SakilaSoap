...
public class Film  implements java.io.Serializable {
    ...
    public Film(Language languageByLanguageId, Language languageByOriginalLanguageId, String title, String description, Integer releaseYear, byte rentalDuration, BigDecimal rentalRate, Short length, BigDecimal replacementCost, String rating, String specialFeatures, Date lastUpdate, Set<Inventory> inventories, Set<FilmActor> filmActors, Set<FilmCategory> filmCategories) {
